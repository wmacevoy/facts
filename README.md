...
Notice the __TWICE__ .  There is no easy way to get around this and stick to the C language.  This means be careful about fact-checks that have side-effects; the failure.

The `FactsFiction` makes it easy to set a break point in the debugger to inspect a failure.
