...
#include <iostream>
  ...
  #define FACTS_OSTREAM00(x,...) "!!! too many watch values, break-up on or before " << #x << " !!!"
  #define FACTS_OSTREAM01(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM00(__VA_ARGS__))
  #define FACTS_OSTREAM02(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM01(__VA_ARGS__))
  #define FACTS_OSTREAM03(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM02(__VA_ARGS__))
  #define FACTS_OSTREAM04(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM03(__VA_ARGS__))
  #define FACTS_OSTREAM05(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM04(__VA_ARGS__))
  #define FACTS_OSTREAM06(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM05(__VA_ARGS__))
  #define FACTS_OSTREAM07(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM06(__VA_ARGS__))
  #define FACTS_OSTREAM08(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM07(__VA_ARGS__))
  #define FACTS_OSTREAM09(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM08(__VA_ARGS__))
  #define FACTS_OSTREAM10(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM09(__VA_ARGS__))
  #define FACTS_OSTREAM11(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM10(__VA_ARGS__))
  #define FACTS_OSTREAM12(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM11(__VA_ARGS__))
  #define FACTS_OSTREAM13(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM12(__VA_ARGS__))
  #define FACTS_OSTREAM14(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM13(__VA_ARGS__))
  #define FACTS_OSTREAM15(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM14(__VA_ARGS__))
  #define FACTS_OSTREAM16(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM15(__VA_ARGS__))
  #define FACTS_OSTREAM17(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM16(__VA_ARGS__))
  #define FACTS_OSTREAM18(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM17(__VA_ARGS__))
  #define FACTS_OSTREAM19(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM18(__VA_ARGS__))
  #define FACTS_OSTREAM20(x,...) #x << "=" << (x) __VA_OPT__(<< " " <<  FACTS_OSTREAM19(__VA_ARGS__))
  #define FACTS_WATCH(...) FACTS_TRACE(FACTS_OSTREAM20(__VA_ARGS__))
