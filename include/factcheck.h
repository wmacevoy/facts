...
#include <stdint.h>
  ...
  typedef struct FactCheckStruct FactCheck;
...
#define FACT_JUNIT 1
  ...
  void FactCheckFindInMemory(FactCheck *begin, FactCheck *end);
  ...
  int FactMain(int argc, const char *argv[]);
